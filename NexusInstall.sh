...
# sudo yum install java-1.8.0-openjdk -y || { echo "Failed to install Java"; exit 1; }wget https://download.oracle.com/java/17/latest/jdk-17_linux-x64_bin.tar.gz
...
#echo "Creating group - Nexus"
#sudo groupadd nexus || { echo "Failed to create group 'nexus'"; exit 1; }

#echo "Creating nexus as a system account and adding it to the nexus group"
#sudo useradd --system --no-create-home -g nexus nexus || { echo "Failed to create 'nexus' user"; exit 1; }
